...
object Spark01_WordCount {
    ...
    def main(args: Array[String]): Unit = {
        ...
        // 1. 读取文件，获取一行一行的数据
        //    hello world
        val lines: RDD[String] = sc.textFile("D:\\work\\code\\spark\\spark-core\\src\\main\\java\\com\\atguigu\\bigdata\\spark\\core\\datas")
        ...
        var word = sc.makeRDD(List("hello","dsfa","dsfa","dsf","dfsf"))
